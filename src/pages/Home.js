      ...
      >
        <div className="carousel-inner ">
          <div className="carousel-item active">
            <img src={Image1} className="d-block w-50 height-400" alt="Uml  1 slider" />
          </div>
          <div className="carousel-item">
            <img src={Image2} className="d-block w-50 height-400" alt="uml  2 slider" />
          </div>
          <div className="carousel-item">
            <img src={Image3} className="d-block w-50 height-400" alt="uml  3 slider" />
          </div>
        </div>
        <button
